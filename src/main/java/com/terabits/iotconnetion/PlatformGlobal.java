...
public class PlatformGlobal {
    ...
    public static String appId = "oCHc5_RAf_CwxdU3zNEYqINaGbka";
    public static String secret = "ODfSA8boieLFyz57eW52zvMyalwa";
    ...
    public static String callbackUrl = "http://112.124.6.31:8080/NBReceiver/test";
